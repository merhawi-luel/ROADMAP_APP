...
-- CreateIndex
CREATE INDEX "ChecklistItem_roadmapId_idx" ON "ChecklistItem"("roadmapId");
...
-- AddForeignKey
ALTER TABLE "ChecklistItem" ADD CONSTRAINT "ChecklistItem_roadmapId_fkey" FOREIGN KEY ("roadmapId") REFERENCES "Roadmap"("id") ON DELETE CASCADE ON UPDATE CASCADE;
